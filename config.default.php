...
// LDAP
//----------------------------------------------------------------------------
$LDAPServer='dc.domain.com';	// Адрес сервера LDAP (Контроллер домена).
$LDAPUser='domain_read_user@domain.com'; // Учетная запись c правом чтения из LDAP. Можно писать в формате user_for_reading_ldap@YOUR_DOMAIN
$LDAPPassword='password_for_domain_read_user'; // Пароль для учетной записи, указанной в переменной $LDAPUser
$LDAP_WRITE_USER='domain_write_user@domain.com';	// Учетная запись c правами записи в LDAP.
...
$OU="OU=orgunit,DC=domain,DC=com"; // В каком Organization Unit искать сотрудников. Оставляем двойные кавычки (внутри, если есть пробелы - обязательно заключать в одинарные кавычки).
...
//----------------------------------------------------------------------------
$ADMIN_LOGINS[]='first_admin@domain.com';
$ADMIN_LOGINS[]='second_admin@domain.com';
$ADMIN_LOGINS[]='third_admin@domain.com';
//----------------------------------------------------------------------------
